// MAKE SURE ABOUT parseInt() method to convert string char to int 
// MAKE SURE ABOUT || and && condition because we made mistake here using ||
// incredible job got correct answer in first try 
function EvaluateReversePolishNotationLeetcode150(arr){
 let stack = [];
